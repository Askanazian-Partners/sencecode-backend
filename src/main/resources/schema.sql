...
CREATE TABLE timesheet (
  ...
  period CHAR(4) NOT NULL,
  ssn CHAR(10) NOT NULL,
  day_1 TINYINT UNSIGNED NOT NULL,
  day_2 TINYINT UNSIGNED NOT NULL,
  day_3 TINYINT UNSIGNED NOT NULL,
  day_4 TINYINT UNSIGNED NOT NULL,
  day_5 TINYINT UNSIGNED NOT NULL,
  day_6 TINYINT UNSIGNED NOT NULL,
  day_7 TINYINT UNSIGNED NOT NULL,
  day_8 TINYINT UNSIGNED NOT NULL,
  day_9 TINYINT UNSIGNED NOT NULL,
  day_10 TINYINT UNSIGNED NOT NULL,
  day_11 TINYINT UNSIGNED NOT NULL,
  day_12 TINYINT UNSIGNED NOT NULL,
  day_13 TINYINT UNSIGNED NOT NULL,
  day_14 TINYINT UNSIGNED NOT NULL,
  day_15 TINYINT UNSIGNED NOT NULL,
  day_16 TINYINT UNSIGNED NOT NULL,
  day_17 TINYINT UNSIGNED NOT NULL,
  day_18 TINYINT UNSIGNED NOT NULL,
  day_19 TINYINT UNSIGNED NOT NULL,
  day_20 TINYINT UNSIGNED NOT NULL,
  day_21 TINYINT UNSIGNED NOT NULL,
  day_22 TINYINT UNSIGNED NOT NULL,
  day_23 TINYINT UNSIGNED NOT NULL,
  day_24 TINYINT UNSIGNED NOT NULL,
  day_25 TINYINT UNSIGNED NOT NULL,
  day_26 TINYINT UNSIGNED NOT NULL,
  day_27 TINYINT UNSIGNED NOT NULL,
  day_28 TINYINT UNSIGNED NOT NULL,
  day_29 TINYINT UNSIGNED NOT NULL,
  day_30 TINYINT UNSIGNED NOT NULL,
  day_31 TINYINT UNSIGNED NOT NULL,
